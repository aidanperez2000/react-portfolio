...
import { FaReact, FaPython, FaAws, FaCode, FaGithub, FaLinkedin } from "react-icons/fa";
    ...
    <div className={darkMode ? "dark bg-gray-900 text-white min-h-screen" : "bg-white text-gray-900 min-h-screen"}>
      ...
      <div className="fixed top-1/2 left-4 transform -translate-y-1/2 flex flex-col space-y-4">
        ...
        <a href="https://github.com/aidanperez2000" target="_blank" rel="noopener noreferrer"
          className="bg-gray-900 text-white p-3 rounded-full shadow-md hover:bg-gray-700 transition"
      ...
      <section className="h-screen flex flex-col justify-center items-center text-center p-10">
        <motion.h1 className="text-5xl font-extrabold flex"
